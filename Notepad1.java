...
class Notepad1 extends WindowAdapter implements ActionListener 
{
	...
	Notepad1()
	{
		...
		//menu1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,InputEvent.ALT_DOWN_MASK));
		menu2=new JMenu("Edit");
		menu2.setMnemonic(KeyEvent.VK_E);
		//menu2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,InputEvent.ALT_DOWN_MASK));
		menu3=new JMenu("View");
		menu3.setMnemonic(KeyEvent.VK_V);
		//menu3.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,InputEvent.ALT_DOWN_MASK));
